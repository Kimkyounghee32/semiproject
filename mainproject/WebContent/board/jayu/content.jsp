...
<script type="text/javascript">
		...
		function list()
		{
			...
			$.ajax({
				...
				url:"/mainproject/board/jayu/answerlist.jsp", //url : 데이터를 전송할 URL
	...
	$(function(){
		...
		$("#btnrepleconfirm").click(function(){
			...
			$.ajax({
				...
				url:"/mainproject/board/jayu/insertanswer.jsp", //url : 데이터를 전송할 URL
		...
		$(document).on("click","span.adel", function() {
			...
			//alert(idx);
			 $.ajax({
				type:"get",
				dataType: "html",
				url:"/mainproject/board/jayu/answerdelete.jsp",
				error : function(){ 
					alert('통신실패!!');
		 		},	
				data:{"idx":idx},
